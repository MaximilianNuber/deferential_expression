...
Welcome to `deferential_expression` contributor's guide.
...
If you experience bugs or general issues with `deferential_expression`, please have a look
...
You can help improve `deferential_expression` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`deferential_expression` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `deferential_expression`'s files. While this mechanism can
...
```
conda create -n deferential_expression python=3 six virtualenv pytest pytest-cov
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/deferential_expression.git
   cd deferential_expression
   ```
...
5. Install [pre-commit]:
   ...
   `deferential_expression` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/deferential_expression
[issue tracker]: https://github.com/<USERNAME>/deferential_expression/issues
