...
_DEPRECATION_MSG = """
RESummarizedExperiment is deprecated and will be removed in a future version.

Use BiocPy's SummarizedExperiment with initialize_r() instead:

    from summarizedexperiment import SummarizedExperiment
    from deferential_expression import initialize_r
    
    se = SummarizedExperiment(assays={'counts': counts}, ...)
    se = initialize_r(se, assay='counts')  # Convert assay to RMatrixAdapter
    
    # Now use edgeR/limma/sva functions directly
    import deferential_expression.edger as edger
    se = edger.calc_norm_factors(se)

This works with any BiocPy SE variant: SummarizedExperiment, 
...
class RESummarizedExperiment(SummarizedExperiment): # type: ignore[misc]
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        .. deprecated::
            Use BiocPy's SummarizedExperiment with initialize_r() instead.
            RESummarizedExperiment will be removed in a future version.
